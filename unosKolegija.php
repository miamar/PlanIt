...
<body>
    ...
    <div class="nav flex-column nav-pills sticky-top" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <hr style="width: 80%; align-self: center;">
      <a class="nav-link" id="v-pills-raspored-tab" data-toggle="pill" href="raspored.php" role="tab" aria-controls="v-pills-raspored" aria-selected="false">Rapored sati</a>
      <hr style="width: 80%; align-self: center;">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-6" style="margin-top: 1em;">
           <p style="color: darkgray;">Unos kolegija</p>
        </div>
        <div class="col-6" style="margin-top: 1em;">
        ...
        <div class="container">
               <div class="row">
                 ...
                 <div class="col-md-6 col-12 justify-content-center" >
                      <button type="button" class="btn "><img class="center" src="elektronickoGospodarstvo.jpg" width="125px" height="125px"></button>
                        <form class="text-right">
                        <div class="form-group">
                            <label class="from-control">Ime kolegija</label>
                            <input type="ime" class="form-control" id="ime">
                        </div>
                        <div class="form-group">
                            <label class="from-control">Dvorana za predavanje</label>
                            <input type="dvoranaPredavanje" class="form-control" id="dvoranaPredavanje">
                          </div>
                    <div class="form-group">
                      <label for="dvoranaVjezbe">Dvorana za vježbe</label>
                      <input type="dvoranaVjezbe" class="form-control" id="dvoranaVjezbe" aria-describedby="dvoranaVjezbelHelp">
                    </div>
                    <div class="form-group">
                      <label for="modelNastave">Model nastave</label>
                      <input type="modelNastave" class="form-control" id="modelNastave">
                    </div>
                    <br>
