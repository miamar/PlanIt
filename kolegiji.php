...
<body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-6" style="margin-top: 1em;">
           <p style="color: darkgray;">Kolegiji</p>
        </div>
        <div class="col-6" style="margin-top: 1em;">
    ...
    <div class="row" style="margin-top: 1em;" >
      <div class="col-12">
        <div class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="unosKolegija.php">Unesi novi kolegij</a></li>
            <li><a class="dropdown-item" href="brisanjeKolegija.php">Obriši kolegij</a></li>
          </ul>
        </div>
       </div>
    </div>
    ...
    <div class="row justify-content-center" style="margin-top: 1em; margin-bottom: 1em;">
      <div class="col-md-auto">
        <a href="podaciKolegij.php"><div class="card" style="width: 18rem;">
          <img src="elektronickoGospodarstvo.jpg" class="card-img-top" alt="..."  style="height:12em;">
          <div class="card-body">
            <p class="card-text"><h4 class="text-left">Elektroničko gospodarstvo</h4>
              <p><strong>P:358, V:358 </strong></p>
              <p>Hibridni model</p> </p>
          </div>
        </div></a>
      </div>
      <div class="col-md-auto">
        <a href="podaciKolegij.php"><div class="card" style="width: 18rem;">
          <img src="inteligentniSustavi.jpg" class="card-img-top" alt="..." style="height:12em;">
          <div class="card-body">
            <p class="card-text"><h4 class="text-left">Inteligentni sustavi 1</h4>
        <p><strong>P:028, V:366 </strong></p>
        <p>Hibridni model</p> </p>
          </div>
        </div></a>
      </div>
      <div class="col-md-auto">
        <a href="podaciKolegij.php"><div class="card" style="width: 18rem;">
          <img src="programskoInzenjerstvo.jpg" class="card-img-top" alt="..."  style="height:12em;">
          <div class="card-body">
            <p class="card-text"><h4 class="text-left">Programsko inženjerstvo</h4>
              <p><strong>P:028, V:350 </strong></p>
              <p>Hibridni model</p> </p>
          </div>
        </div></a>
      </div>
      <div class="col-md-auto">
        <a href="podaciKolegij.php"><div class="card" style="width: 18rem;">
          <img src="ekonomikaPoslovanja.png" class="card-img-top" alt="..."  style="height:12em;">
          <div class="card-body">
            <p class="card-text"><h4 class="text-left">Ekonomoka Poslovanja</h4>
              <p><strong>P:028, V:366 </strong></p>
              <p>Hibridni model</p> </p>
          </div>
        </div></a>
      ...
      <div class="col-md-auto">
        <a href="podaciKolegij.php"><div class="card" style="width: 18rem;">
          <img src="operacijskaIstrazivanja.jpg" class="card-img-top" alt="..."  style="height:12em;">
          <div class="card-body">
            <p class="card-text"><h4 class="text-left">Operacijska istraživanja 1</h4>
              <p><strong>P:S32, V:350 </strong></p>
              <p>Hibridni model</p></p>
          </div>
        </div></a>
      </div>
      ...
      <div class="card" style="width: 28rem;">
        <div class="card-horizontal">
            <div class="img-square-wrapper" justify-content-center">
                <img class="" src="elektronickoGospodarstvo.jpg" alt="Card image cap" width="150px">
            </div>
            <div class="card-body">
