...
<body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-6" style="margin-top: 1em;">
           <p style="color: darkgray;">Brisanje kolegija</p>
        </div>
        <div class="col-6" style="margin-top: 1em;">
    ...
    <div class="row" style="margin-top: 1em;">
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
                <h4 class="text-left">Elektroničko gospodarstvo</h4>
      ...
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h4 class="text-left">Inteligentni sustavi 1</h4>
      ...
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h4 class="text-left">Operacijska istraživanja 1</h4>
      ...
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h4 class="text-left">Ekonomoka Poslovanja</h4>
            <p><strong>P:028, V:366 </strong></p>
            <p>Hibridni model</p>
                <button type="delete" class="btn btn-danger">Izbriši</button>
          </div>
      ...
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h4 class="text-left">Programsko inženjerstvo</h4>
