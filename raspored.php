...
<body>
    <div class="nav flex-column nav-pills  sticky-top" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <hr style="width: 80%; align-self: center;">
        <a class="nav-link" id="v-pills-obavijesti-tab" data-toggle="pill" href="obavijesti.phps" role="tab" aria-controls="v-pills-obavijesti" aria-selected="false">Obavijesti</a>
        <hr style="width: 80%; align-self: center;">
    </div>
    <div class="container-fluid">
        <div class="row">
            <div class="col-6" style="margin-top: 1em;">
               <p style="color: darkgray;">Raspored sati</p>
            </div>
            <div class="col-6" style="margin-top: 1em;">
        ...
        <div class="row">
          <div class="col-sm-12 col-12 d-flex justify-content-center" >
            <a class="btn btn-primary" href="unosRasporeda.php" role="button">Dodaj novi raspored sati</a>
          </div>
    </div>
